    ...
    >
      ...
      <el-table-column class-name="status-col" label="计费规则" align="left">
        <template slot-scope="scope">
          <div>
              <div>
                  路程成本价：<span class="text-red">{{scope.row.roadBasePrice}}</span> 元/公里，
                  <span class="text-blue">{{scope.row.baseDist}}</span> 公里内：<span class="text-red">{{scope.row.roadSellPrice}}</span> 元/公里
                  （不足按{{scope.row.baseDist}}公里算），
              ...
              <div>
                  工时费成本价： <span class="text-red">{{scope.row.checkBasePrice}}</span> 元/时，
                  <span class="text-green">{{scope.row.baseHour}}</span> 时内 <span class="text-red">{{scope.row.checkSellPrice}}</span> 元/工时
                  （不足按{{scope.row.baseHour}}时算），
